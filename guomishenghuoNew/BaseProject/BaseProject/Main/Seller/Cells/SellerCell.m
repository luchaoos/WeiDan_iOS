...
+ (SellerCell *)cellWithTableView:(UITableView *)tableView{
    ...
    SellerCell *cell = [tableView dequeueReusableCellWithIdentifier:ident];
    if (!cell) {
        cell = [[SellerCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ident
                ];
