...
- (void)InitScan
{
    ...
    readview.alpha = 0;
    [readview.openFrame addTarget:self action:@selector(alumbBtnEvent) forControlEvents:UIControlEventTouchUpInside];
...
//        [alertView show];
        ...
        [self dismissViewControllerAnimated:YES completion:^{
            [[NSNotificationCenter defaultCenter] postNotificationName:@"scanSuccess" object:str userInfo:nil];
        }];
