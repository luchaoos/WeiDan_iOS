...
-(BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text{
    ...
    if ([self.mydelegate respondsToSelector:@selector(mytextView:shouldChangeTextInRange:replacementText:)]) {
        return [self.mydelegate mytextView:self shouldChangeTextInRange:range replacementText:text];
    }
    else
    {
        return YES;
