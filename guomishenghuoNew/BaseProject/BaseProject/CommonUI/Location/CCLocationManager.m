...
@property (nonatomic, strong) NSStringBlock xianquBlock;
...
- (void) getLocationCoordinate:(LocationBlock) locaiontBlock  withAddress:(NSStringBlock) addressBlock withCityBlock:(NSStringBlock)cityBlock
{
    self.locationBlock = [locaiontBlock copy];
...
//获取县区
- (void) getCityNext:(NSStringBlock)xianquBlock
{
    self.xianquBlock = [xianquBlock copy];
    [self startLocation];
}
...
//             NSLog(@"______%@",_lastCity);
             _lastXianQu=[NSString stringWithFormat:@"%@",placemark.subLocality];

//             _lastAddress = [NSString stringWithFormat:@"%@%@%@%@%@%@",placemark.countrty,placemark.administrativeArea,placemark.locality,placemark.subLocality,placemark.thoroughfare,placemark.subThoroughfare];//详细地址
             _lastAddress = [NSString stringWithFormat:@"%@%@%@",placemark.subLocality,placemark.thoroughfare,placemark.subThoroughfare];//详细地址
